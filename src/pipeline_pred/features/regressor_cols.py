"""Legacy EIA regressor column sets retained for future horizon modeling."""
...
def cols_for_total() -> list[str]:
    return ["CurrentClose", "FuturesClose"]
...
def future_regressors() -> list[str]:
    return ["CurrentClose", "FuturesClose"]
